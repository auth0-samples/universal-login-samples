      ...
      <div className="bg-white rounded-lg shadow-md w-full max-w-sm p-8">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white ${loading ? "bg-indigo-400" : "bg-indigo-600 hover:bg-indigo-700"
        ...
        {/* {tenant.enabledLocales && (
          <div className="mt-6 text-center">
            ...
            <select
              ...
              className="block mx-auto px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            >
