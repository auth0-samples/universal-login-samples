...
const ResetPasswordRequest = React.lazy(() => import("./screens/reset-password-request"));
...
const ResetPasswordEmail = React.lazy(() => import("./screens/reset-password-email"));
const ResetPassword = React.lazy(() => import("./screens/reset-password"));
const ResetPasswordError = React.lazy(() => import("./screens/reset-password-error"));
const ResetPasswordSuccess = React.lazy(() => import("./screens/reset-password-success"));
